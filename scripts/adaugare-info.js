        ...
        pluszile.addEventListener('click',()=>
            {
                ...
                {
                    document.querySelector('.container-fara-cont').remove();
                }
                ...
                <div class="sectiune">
                    <div class="subtitlu">
                        ...
                        Ziua
                        <input type = "text" name = "input-zi-${uniqueIDZi}-nou" value = "GOL" placeholder = "Nume zi ..."></div>
                    </div>
                    <div class="rand">
...
function createExercise(idZi)
{
    ...
    <div class="col">
            <div class="greutati">
                <div style="margin-bottom: 5px;"><input type="text" class = "greutate-${idNou} greutate-${idNou} nou" name="greutate-${idNou}-nou-${idNou}" value=""></div>
            </div>
    </div>`;
    ...
    <div class="col">
            <div class="repetari">
                <div class = "container-cu-minus">
                    <div style="margin-bottom: 5px;"><input type="text" class = "repetari-${idNou} repetari-${idNou}" name="repetare-${idNou}-nou-${idNou}" value=""></div>
